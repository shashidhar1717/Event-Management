...
<body class="container"
	...
	<div class="container-fluid my-4">
		<div
			...
			<div class="col-6">
				<h1 class="featurette-heading">About Samrat Events</h1>
				<p>At Samrat Events, we are passionate about creating
		...
		<div
			...
			<div class="col-6 order-2">
				...
				<p>At Samrat Events, our vision is to be the premier provider of
